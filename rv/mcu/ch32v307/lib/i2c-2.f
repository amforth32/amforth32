\ ============================================================
\ I2C2 master for CH32V307 — polled, on PB10/PB11
\ Pins: PB10 = SCL, PB11 = SDA  (I2C2 default mapping, no remap needed)
...
\ ---- I2C2 register block ----
\ (Names kept as I2C1.* for cross-file diffability; refer to I2C2 hardware.)
$40005800 constant I2C1.CTLR1
$40005804 constant I2C1.CTLR2
$40005808 constant I2C1.OADDR1
$4000580C constant I2C1.OADDR2
$40005810 constant I2C1.DATAR
$40005814 constant I2C1.STAR1
$40005818 constant I2C1.STAR2
$4000581C constant I2C1.CKCFGR
$40005820 constant I2C1.RTR

\ ---- RCC ----
$40021018 constant RCC.APB2PCENR
$4002101C constant RCC.APB1PCENR
$40021010 constant RCC.APB1PRSTR
$00000001 constant RCC.APB2.AFIOEN     \ unused for I2C2 (no remap) but kept
$00000008 constant RCC.APB2.IOPBEN
$00400000 constant RCC.APB1.I2C1EN     \ I2C2 enable: APB1 bit 22
$00400000 constant RCC.APB1.I2C1RST    \ I2C2 reset:  APB1 bit 22

\ ---- AFIO (not used for I2C2, retained for parity) ----
$40010004 constant AFIO.PCFR1
$00000000 constant AFIO.I2C1_REMAP     \ no remap for I2C2
...
\ Bring-up
\ ============================================================
\ PB10 nibble at CFGHR[11:8], PB11 nibble at CFGHR[15:12].
\ CNF=11 (AF open-drain), MODE=11 (50MHz) -> nibble $f per pin.
\ Mask for both nibbles: $0000ff00.
\ No AFIO remap needed for I2C2 — pins are hardwired to the peripheral.
: i2c.gpio-init
