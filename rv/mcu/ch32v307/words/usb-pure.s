...
#======================================================================
#======================================================================
# transpiling usb-pure.f on 2026/05/16 18:02:04
# \ ======================================================================
# \ Forth versions of asm CODEWORDs from usb-new.s
# \ Each "FORTH OF asm-name" comment marks a replacement.
# \ Drop in to usb-forth1.f. Remove the corresponding CODEWORDs from
# \ usb-new.s to avoid duplicate definitions.
# \ ======================================================================
# 
# \ fudge block
# \ : :~ : ;
...
# $40023400 constant R8_USB_CTRL
# $40023401 constant R8_UHOST_CTRL
# $40023402 constant R8_USB_INT_EN
# $40023408 constant R8_USB_SPPED_TYPE
# $40023409 constant R8_USB_MIS_ST
# $4002340B constant R8_USB_INT_ST
# 
# $D1000000 constant USBHS_CFGR2_VAL
# $00000800 constant USBHS_AHBEN_BIT
# 
# $20 constant UC_SPEED_HIGH
# $10 constant UC_DEV_PU_EN
# $08 constant UC_INT_BUSY
# $04 constant UC_RESET_SIE
# $02 constant UC_CLR_ALL
# $01 constant UC_DMA_EN
# 
# $20 constant UIE_SETUP_ACT_BIT
# $04 constant UIE_SUSPEND_BIT
# $02 constant UIE_TRANSFER_BIT
# $01 constant UIE_BUS_RST_BIT
# 
# $E000E100 constant PFIC_IENR_BASE
# $E000E180 constant PFIC_IRER_BASE
# 
# $200 constant RING_MASK            \ 0x1FF + 1 sentinel; use $1FF as mask
# $1FF constant RING_BYTEMASK
# 
# $40023410 constant R32_UEP_CONFIG
# $40023424 constant R32_UEP2_RX_DMA
# $40023460 constant R32_UEP2_TX_DMA
# $40023464 constant R32_UEP3_TX_DMA
# $400234a0 constant R16_UEP2_MAX_LEN
# $400234a4 constant R16_UEP3_MAX_LEN
# $400234e0 constant R16_UEP2_T_LEN
# $400234e2 constant R8_UEP2_TX_CTRL
# $400234e3 constant R8_UEP2_RX_CTRL
# $400234e4 constant R16_UEP3_T_LEN
# $400234e6 constant R8_UEP3_TX_CTRL
# 
# \ debug counters
# 
# variable~ usb.int.count
# variable~ usb.rst.count
# variable~ usb.setup.count
# variable~ usb.xfer.count
# variable~ usb.susp.count
# variable~ usb.other.count
# 
# :~ usb.zero \# ( -- ) zero usb debug stats
#     0 usb.int.count   !
#     0 usb.rst.count   !
#     0 usb.setup.count !
#     0 usb.xfer.count  !
...
# 
# $40023403 constant R8_USB_DEV_AD
# $4002340a constant R8_USB_INT_FG
# $4002341c constant R32_UEP0_DMA
# $40023498 constant R16_UEP0_MAX_LEN
# $400234d8 constant R16_UEP0_T_LEN
# $400234da constant R8_UEP0_TX_CTRL
# $400234db constant R8_UEP0_RX_CTRL
# 
# \ ---- Forth-visible bit-mask-------------------------
# 
# $01 constant UIF_BUS_RST
# $02 constant UIF_TRANSFER
# $04 constant UIF_SUSPEND
# $20 constant UIF_SETUP_ACT
# 
# $08 constant UEP_T_TOG_DATA1
# $08 constant UEP_R_TOG_DATA1
# 
# $00 constant UEP_T_RES_ACK
# $02 constant UEP_T_RES_NAK
# $03 constant UEP_T_RES_STALL
# 
# $00 constant UEP_R_RES_ACK
# $02 constant UEP_R_RES_NAK
# $03 constant UEP_R_RES_STALL
# 
# 85  CONSTANT #usbhs
# 
# \ ---- Ring buffer storage (replaces NVARIABLE in usb-new.s) -------
# \ NOTE: if rb-buf/tb-buf already exist as NVARIABLE in usb-new.s,
# \ DO NOT redefine them here. Remove the NVARIABLE versions in the asm.
# 
# \ create rb-buf  #512 allot   \ FORTH OF NVARIABLE rb-buf
# \ create tb-buf  #512 allot   \ FORTH OF NVARIABLE tb-buf
# 
# #128 nvariable~ rb-buf
# #128 nvariable~ tb-buf
# 
# variable~ rb-head            \ FORTH OF NVARIABLE rb-head
# variable~ rb-tail            \ FORTH OF NVARIABLE rb-tail
# variable~ tb-head            \ FORTH OF NVARIABLE tb-head
# variable~ tb-tail            \ FORTH OF NVARIABLE tb-tail
# 
# $1ff constant rb-mask
# $1ff constant tb-mask
# 
...
# 
# #128 nvariable~ EP2_RX_buf
# #128 nvariable~ EP2_TX_buf
# #16  nvariable~ EP3_TX_buf
# 
# \ ---- Ring buffer primitives --------------------------------------
# 
# :~ rb-empty? ( -- f )        \ FORTH OF CODEWORD rb-empty?
#     rb-head @ rb-tail @ =
# ;
# 
# :~ rb-full? ( -- f )         \ FORTH OF CODEWORD rb-full?
#     rb-head @ 1+ RING_BYTEMASK and  rb-tail @ =
# ;
# 
# :~ rb-count ( -- n )         \ FORTH OF CODEWORD rb-count
#     rb-head @ rb-tail @ -  RING_BYTEMASK and
# ;
# 
# :~ rb-push ( c -- f )        \ FORTH OF CODEWORD rb-push
#     rb-head @
#     dup 1+ RING_BYTEMASK and
#     dup rb-tail @ = if
#         2drop drop 0 exit
#     then
#     >r                      ( c head  R: new-head )
#     rb-buf + c!             \ write byte at old head
#     r> rb-head !            \ publish new head
#     -1
# ;
# 
# :~ rb-pop ( -- c )           \ FORTH OF CODEWORD rb-pop
#     rb-tail @
#     dup rb-buf + c@         ( tail c )
#     swap 1+ RING_BYTEMASK and  rb-tail !
# ;
# 
# :~ tb-empty? ( -- f )        \ FORTH OF CODEWORD tb-empty?
#     tb-head @ tb-tail @ =
# ;
# 
# :~ tb-full? ( -- f )         \ FORTH OF CODEWORD tb-full?
#     tb-head @ 1+ RING_BYTEMASK and  tb-tail @ =
# ;
# 
# :~ tb-count ( -- n )         \ FORTH OF CODEWORD tb-count
#     tb-head @ tb-tail @ -  RING_BYTEMASK and
# ;
# 
# :~ tb-push ( c -- f )        \ FORTH OF CODEWORD tb-push
#     tb-head @
#     dup 1+ RING_BYTEMASK and
#     dup tb-tail @ = if
#         2drop drop 0 exit
...
# ;
# 
# :~ tb-pop ( -- c )           \ FORTH OF CODEWORD tb-pop
#     tb-tail @
#     dup tb-buf + c@
#     swap 1+ RING_BYTEMASK and  tb-tail !
# ;
# 
# \ ---- PFIC IRQ enable/disable -------------------------------------
# 
# : +irq ( n -- )             \ FORTH OF CODEWORD +irq
#     dup 5 rshift cells PFIC_IENR_BASE +   \ register address
#     swap $1F and  1 swap lshift            \ bit mask
#     swap !
# ;
# 
# : -irq ( n -- )             \ FORTH OF CODEWORD -irq
#     dup 5 rshift cells PFIC_IRER_BASE +
#     swap $1F and  1 swap lshift
#     swap !
# ;
# 
# \ ---- USB clock + device-mode bring-up ----------------------------
# 
# :~ +usbhs.clk ( -- )         \ FORTH OF CODEWORD +usbhs.clk
#     USBHS_CFGR2_VAL  R32_RCC_CFGR2 !
#     R32_RCC_AHBPCENR @  USBHS_AHBEN_BIT or  R32_RCC_AHBPCENR !
# ;
# 
# :~ usb-delay ( -- )          \ internal: ~1000-iter busy loop
#     #1000 0 do loop
# ;
# 
# :~ +usbhs-device ( -- )      \ FORTH OF CODEWORD +usbhs-device
#     UC_CLR_ALL UC_RESET_SIE or  R8_USB_CTRL c!
#     usb-delay
#     UC_CLR_ALL                  R8_USB_CTRL c!
#     $10                         R8_UHOST_CTRL c!
#     UC_DMA_EN UC_INT_BUSY or UC_SPEED_HIGH or  R8_USB_CTRL c!
#     UIE_SETUP_ACT_BIT UIE_TRANSFER_BIT or
#     UIE_BUS_RST_BIT or UIE_SUSPEND_BIT or  R8_USB_INT_EN c!
#     UC_DMA_EN UC_INT_BUSY or UC_SPEED_HIGH or UC_DEV_PU_EN or
#         R8_USB_CTRL c!
# ;
# 
# \ ---- USB INT/status register reads -------------------------------
# 
# :~ uintst@ ( -- b )          \ FORTH OF CODEWORD uintst@
#     R8_USB_INT_ST c@
# ;
# 
# :~ uintfg@ ( -- b )          \ FORTH OF CODEWORD uintfg@
#     R8_USB_INT_FG c@
# ;
# 
# :~ uintfg! ( c -- )          \ FORTH OF CODEWORD uintfg!
#     R8_USB_INT_FG c!
# ;
# 
# :~ cfgr2@ ( -- n )           \ FORTH OF CODEWORD cfgr2@
#     R32_RCC_CFGR2 @
# ;
# 
# :~ ahbpcenr@ ( -- n )        \ FORTH OF CODEWORD ahbpcenr@
#     R32_RCC_AHBPCENR @
# ;
# 
# :~ uctrl@ ( -- b )           \ FORTH OF CODEWORD uctrl@
#     R8_USB_CTRL c@
# ;
# 
# :~ uinten@ ( -- b )          \ FORTH OF CODEWORD uinten@
#     R8_USB_INT_EN c@
# ;
# 
# :~ uhost@ ( -- b )           \ FORTH OF CODEWORD uhost@
#     R8_UHOST_CTRL c@
# ;
# 
# :~ uspeed@ ( -- b )          \ FORTH OF CODEWORD uspeed@
#     R8_USB_SPPED_TYPE c@
# ;
# 
# :~ umis@ ( -- b )            \ FORTH OF CODEWORD umis@
#     R8_USB_MIS_ST c@
# ;
# 
# \ ======================================================================
# \ usb-forth1.f — Phase 2.4f
# \ Bulk data path: EP2 OUT drains into rb; EP2 IN pumps from tb.
# \ usb-emit redefined to kick the TX pump.
# \ TX pump is IRQ-safe (USBHS IRQ masked during Forth-context pump).
# \ Diagnostic instrumentation on dispatch-transfer.
# \ ======================================================================
# 
# align
# create~ dev-descr
...
# 
# create~ cfg-descr
#      9  c, 2 c, #67 c, 0 c, 2 c, 1 c, 0 c, $80 c, #50 c,
#      9  c, 4 c, 0 c, 0 c, 1 c, 2 c, 2 c, 1 c, 0 c,
#      5  c, $24 c, 0 c, $10 c, 1 c,
#      5  c, $24 c, 1 c, 0 c, 0 c,
#      4  c, $24 c, 2 c, 2 c,
#      5  c, $24 c, 6 c, 0 c, 1 c,
#      7  c, 5 c, $83 c, 3 c, #64 c, 0 c, 9 c,
#      9  c, 4 c, 1 c, 0 c, 2 c, #10 c, 0 c, 0 c, 0 c,
#      7  c, 5 c, 2 c, 2 c, 0 c, 2 c, 0 c,
#      7  c, 5 c, $82 c, 2 c, 0 c, 2 c, 0 c,
# align
# 
# create~ str0
#      4 c, 3 c, $09 c, $04 c,
...
# create~ str1
#    #20 c, 3 c,
#    $61 c, 0 c, $6D c, 0 c, $66 c, 0 c, $6F c, 0 c,
#    $72 c, 0 c, $74 c, 0 c, $68 c, 0 c, $33 c, 0 c,
#    $32 c, 0 c,
# align
# 
# create~ str2
...
# 
# create~ line-coding
#     $00 c, $C2 c, $01 c, $00 c, 0 c, 0 c, 8 c,
# align
# 
# create~ status-buf
#     0 c, 0 c,
...
# \ ---- Constants ----------------------------------------------------
# 
# $00 constant USB_GET_STATUS
# $01 constant USB_CLEAR_FEATURE
# $03 constant USB_SET_FEATURE
# $05 constant USB_SET_ADDRESS
# $06 constant USB_GET_DESCRIPTOR
# $08 constant USB_GET_CONFIGURATION
# $09 constant USB_SET_CONFIGURATION
# 
# $20 constant CDC_SET_LINE_CODING
# $21 constant CDC_GET_LINE_CODING
# $22 constant CDC_SET_CONTROL_LINE_STATE
# 
# $01 constant DESC_TYPE_DEVICE
# $02 constant DESC_TYPE_CONFIG
# $03 constant DESC_TYPE_STRING
# $06 constant DESC_TYPE_QUALIFIER
# 
# #18 constant DEV_DESCR_LEN
# #67 constant CFG_DESCR_LEN
#  4  constant STR0_LEN
# #20 constant STR1_LEN
# #20 constant STR2_LEN
#  7  constant LINE_CODING_LEN
#  2  constant STATUS_LEN
# 
# $20 constant UEP_T_AUTO_TOG
# $20 constant UEP_R_AUTO_TOG
# 
# $4002340C constant R16_USB_RX_LEN
# 
# \ ---- State --------------------------------------------------------
# 
# \ create setup-log 16 allot
# 4 nvariable~ setup-log
# variable~ setup-log-idx
# variable~ bad-request
# variable~ bad-desc-type
# variable~ pending-addr
# variable~ current-config
# 
# variable~ ep0-tx-src
# variable~ ep0-tx-rem
# variable~ ep0-tx-tog
# variable~ expecting-out-data
# 
# variable~ last-desc-type
# variable~ last-desc-len
# variable~ last-sent-len
# variable~ last-setup-len
# 
# variable~ ep2-tx-busy
# variable~ ep2-rx-count
# variable~ ep2-tx-count
# 
# \ Diagnostic instrumentation
# variable~ last-uintst
# variable~ last-dispatch-tag
# variable~ last-intfg
# 
# \ ---- SETUP accessors ---------------------------------------------
# 
# :~ setup-rtype      ( -- byte )  EP0buf 0 + c@ ;
# :~ setup-request    ( -- byte )  EP0buf 1 + c@ ;
# :~ setup-value-lo   ( -- byte )  EP0buf 2 + c@ ;
# :~ setup-value-hi   ( -- byte )  EP0buf 3 + c@ ;
# :~ setup-length     ( -- n )     EP0buf 6 + c@ EP0buf 7 + c@ #8 lshift or ;
# 
# :~ log-setup-bytes ( -- )
#     setup-rtype
#     setup-log setup-log-idx @ + c!
#     setup-log-idx @ 1+ $0F and setup-log-idx !
#     setup-request
#     setup-log setup-log-idx @ + c!
#     setup-log-idx @ 1+ $0F and setup-log-idx !
# ;
...
# 
# :~ ep0-stall ( -- )
#     UEP_T_TOG_DATA1 UEP_T_RES_STALL or  R8_UEP0_TX_CTRL c!
#     UEP_R_TOG_DATA1 UEP_R_RES_STALL or  R8_UEP0_RX_CTRL c!
# ;
# 
# :~ ep0-status-in ( -- )
#     0 R16_UEP0_T_LEN h!
#     UEP_T_TOG_DATA1 UEP_T_RES_ACK or  R8_UEP0_TX_CTRL c!
# ;
# 
# :~ ep0-arm-tog ( n -- )
#     R16_UEP0_T_LEN h!
#     ep0-tx-tog @ UEP_T_RES_ACK or  R8_UEP0_TX_CTRL c!
#     ep0-tx-tog @ UEP_T_TOG_DATA1 xor  ep0-tx-tog !
# ;
# 
# :~ ep0-tx-next ( -- )
#     ep0-tx-rem @ ?dup if
...
# ;
# 
# :~ send-descriptor ( src n -- )
#     setup-length dup last-setup-len !  min
#     dup last-sent-len !
#     ep0-tx-rem !
#     ep0-tx-src !
#     UEP_T_TOG_DATA1 ep0-tx-tog !
#     ep0-tx-next
# ;
# 
# \ ---- Bulk endpoint bring-up ---------------------------------------
# 
# :~ +ep-bulk ( -- )
#     EP2_RX_buf R32_UEP2_RX_DMA !
#     EP2_TX_buf R32_UEP2_TX_DMA !
#     EP3_TX_buf R32_UEP3_TX_DMA !
#     #512 R16_UEP2_MAX_LEN h!
#     #64  R16_UEP3_MAX_LEN h!
#     UEP_R_RES_ACK UEP_R_AUTO_TOG or  R8_UEP2_RX_CTRL c!
#     UEP_T_RES_NAK UEP_T_AUTO_TOG or  R8_UEP2_TX_CTRL c!
#     UEP_T_RES_NAK R8_UEP3_TX_CTRL c!
#     0 ep2-tx-busy !
#     $0004000C R32_UEP_CONFIG !
# ;
# 
# \ ---- EP2 data path ------------------------------------------------
# 
...
#     dup ep2-rx-count +!
#     0 ?do
#         EP2_RX_buf i + c@ rb-push drop
#     loop
#     R8_UEP2_RX_CTRL c@  $FC and  R8_UEP2_RX_CTRL c!
# ;
# 
# :~ ep2-tx-pump-unsafe ( -- )
#     ep2-tx-busy @ if exit then
#     tb-count ?dup 0= if exit then
#     #512 min
#     dup >r
#     0 ?do
#         tb-pop EP2_TX_buf i + c!
#     loop
#     r> dup ep2-tx-count +!
#     R16_UEP2_T_LEN h!
#     R8_UEP2_TX_CTRL c@  $FC and  UEP_T_RES_ACK or  R8_UEP2_TX_CTRL c!
#     1 ep2-tx-busy !
# ;
# 
# 
...
# ;
# 
# variable~ txc-call-count
# 
# :~ ep2-tx-complete ( -- )
#     1 txc-call-count +!
#     0 ep2-tx-busy !
#     R8_UEP2_TX_CTRL c@  $FC and  UEP_T_RES_NAK or  R8_UEP2_TX_CTRL c!
#     ep2-tx-pump-unsafe
# ;
# 
# \ ---- Request handlers --------------------------------------------
...
#     setup-value-hi  dup last-desc-type !
#     case
#         DESC_TYPE_DEVICE of
#             DEV_DESCR_LEN dup last-desc-len !
#             >r dev-descr r> send-descriptor
#         endof
#         DESC_TYPE_CONFIG of
#             CFG_DESCR_LEN dup last-desc-len !
#             >r cfg-descr r> send-descriptor
#         endof
#         DESC_TYPE_STRING of
#             setup-value-lo
#             case
#                 0 of str0 STR0_LEN send-descriptor endof
#                 1 of str1 STR1_LEN send-descriptor endof
#                 2 of str2 STR2_LEN send-descriptor endof
#                 ( default ) ep0-stall  1 bad-desc-type +!
#             endcase
#         endof
#         DESC_TYPE_QUALIFIER of ep0-stall endof
#         ( default ) ep0-stall  1 bad-desc-type +!
#     endcase
# ;
# 
# :~ handle-set-address ( -- )
#     setup-value-lo pending-addr !
#     ep0-status-in
# ;
# 
# :~ handle-set-configuration ( -- )
#     setup-value-lo current-config !
#     +ep-bulk
#     ep0-status-in
# ;
# 
# :~ handle-get-configuration ( -- )
#     current-config @ EP0buf c!
#     EP0buf 1 send-descriptor
# ;
# 
# :~ handle-get-status ( -- )
#     status-buf STATUS_LEN send-descriptor
# ;
# 
# :~ handle-set-feature ( -- )
#     ep0-status-in
...
#     setup-request
#     case
#         CDC_SET_LINE_CODING of
#             1 expecting-out-data !
#         endof
#         CDC_GET_LINE_CODING of
#             line-coding LINE_CODING_LEN send-descriptor
#         endof
#         CDC_SET_CONTROL_LINE_STATE of
#             ep0-status-in
#         endof
#         ( default ) ep0-stall  1 bad-request +!
#     endcase
# ;
# 
...
#     setup-request
#     case
#         USB_GET_STATUS        of handle-get-status        endof
#         USB_CLEAR_FEATURE     of handle-clear-feature     endof
#         USB_SET_FEATURE       of handle-set-feature       endof
#         USB_SET_ADDRESS       of handle-set-address       endof
#         USB_GET_DESCRIPTOR    of handle-get-descriptor    endof
#         USB_GET_CONFIGURATION of handle-get-configuration endof
#         USB_SET_CONFIGURATION of handle-set-configuration endof
#         ( default ) ep0-stall  1 bad-request +!
#     endcase
# ;
# 
...
#     setup-rtype $60 and
#     case
#         $00 of handle-standard-request endof
#         $20 of handle-class-request    endof
#         ( default ) ep0-stall  1 bad-request +!
#     endcase
# ;
# 
...
#         0 pending-addr !
#     then
#     expecting-out-data @ if
#         0 expecting-out-data !
#         ep0-status-in
#     else
#         ep0-tx-rem @ if
#             ep0-tx-next
#         else
#             UEP_T_RES_NAK R8_UEP0_TX_CTRL c!
#         then
#     then
# ;
# 
# :~ dispatch-transfer ( -- )
#     uintst@  dup last-uintst !
#     dup $0F and
#     case
#         0 of  drop  $E0 last-dispatch-tag !  handle-ep0-transfer  endof
#         2 of
#             $30 and
#             case
#                 $00 of  $20 last-dispatch-tag !  ep2-rx-drain    endof
#                 $20 of  $21 last-dispatch-tag !  ep2-tx-complete endof
#                 ( default ) $2F last-dispatch-tag !
#             endcase
#         endof
#         ( default ) $FF last-dispatch-tag !  drop
#     endcase
# ;
# 
# \ ---- ISR --------------------------------------------------------
...
# :~ usbhs.isr
#     1 usb.int.count +!
#     R8_USB_INT_FG c@  dup last-intfg !
# 
#     dup UIF_BUS_RST and if
#         1 usb.rst.count +!
#         0 R8_USB_DEV_AD c!
#         0 pending-addr !
#         0 current-config !
...
#         UEP_T_TOG_DATA1 ep0-tx-tog !
#         EP0buf R32_UEP0_DMA !
#         #64    R16_UEP0_MAX_LEN h!
#         UEP_T_RES_NAK R8_UEP0_TX_CTRL c!
#         UEP_R_RES_ACK R8_UEP0_RX_CTRL c!
#         UEP_T_RES_NAK UEP_T_AUTO_TOG or  R8_UEP2_TX_CTRL c!
#         UEP_R_RES_NAK UEP_R_AUTO_TOG or  R8_UEP2_RX_CTRL c!
#         UEP_T_RES_NAK R8_UEP3_TX_CTRL c!
#         0 R32_UEP_CONFIG !
#         0 rb-head !  0 rb-tail !
#         0 tb-head !  0 tb-tail !
#         UIF_BUS_RST R8_USB_INT_FG c!
#     then
# 
#     dup UIF_TRANSFER and if
#         1 usb.xfer.count +!
#         dispatch-transfer
#         UIF_TRANSFER R8_USB_INT_FG c!
#     then
# 
#     dup UIF_SETUP_ACT and if
#         1 usb.setup.count +!
#         handle-setup
#         UIF_SETUP_ACT R8_USB_INT_FG c!
#     then
# 
#     UIF_SUSPEND and if
#         1 usb.susp.count +!
#         UIF_SUSPEND R8_USB_INT_FG c!
#     then
# ;i
# 
# :~ usb.install
#     ['] usbhs.isr  #usbhs trap!
#     #usbhs +irq
# ;
# 
# \ usb.install
# 
# \ ---- Override usb-emit / usb-key to drive bulk endpoints ---------
# 
# : usb-emit ( c -- )
#     current-config @ 0= if drop exit then
#     tb-push drop
#     ep2-tx-pump
# ;
# 
...
# 
# : usb-key-pause ( -- c )
#     begin pause usb-key? until
#     usb-key
# ;
# 
# : usb-enum?  \# ( -- f ) true if device is enumerated and configured
#     current-config @ 0<>
# ;
# 
# : usb \# ( -- ) switch operator to usb connection, if connection ready (10s TO)
# 
#     tick@ #10 ms.tickf * >r
#     begin
#         tick@ over - r@ u> usb-enum? or
#     until drop rdrop
# 
#     usb-enum? if
#         +led
...
NOCON "RING_BYTEMASK", RINGUNDERBYTEMASK, 511
...
END HASHUSBHS
NONVAR "rb-buf", RBMINUSBUF, 128
END RBMINUSBUF
NONVAR "tb-buf", TBMINUSBUF, 128
END TBMINUSBUF
...
NONAME "+ep-bulk", PLUSEPMINUSBULK 
	...
	.word XT_HSTORE
	.word XT_DOLITERAL
	.word 0 /* UEP_R_RES_ACK (inline constant) */
	.word XT_DOLITERAL
